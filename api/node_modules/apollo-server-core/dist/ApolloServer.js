...
class ApolloServerBase {
    constructor(config) {
        ...
        const { context, resolvers, schema, schemaDirectives, typeDefs, introspection, mocks, extensions, engine, subscriptions } = config, requestOptions = __rest(config, ["context", "resolvers", "schema", "schemaDirectives", "typeDefs", "introspection", "mocks", "extensions", "engine", "subscriptions"]);
        ...
        if (!requestOptions.cache) {
            requestOptions.cache = new apollo_datasource_rest_1.InMemoryKeyValueCache();
        }
